...
Purpose of script: automatically run and save the propagation modeling for a set range of variables. Currently this is set up to grab values semi-randomly using LHS, but can easily change to static variables.
...
# Avg_Signal_dB        - Output, signal strength of the arriving rays in dB re 1 µPa. Note: this is calculated using the power set in "CAE_arrivals". Please ensure you set the transmitting strength to your tag's setting.
# 
